...
specs = do
  ...
  it "rows & cols" $ (rows &&& cols) (intMatrix "1 2") `shouldBe` (1, 2)
  ...
  it "reshape" $ reshape (2, 2) (intMatrix "1 2 3 4") `shouldBe` intMatrix
    "1 2\n3 4"
