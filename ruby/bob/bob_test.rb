...
class BobTest < Minitest::Test
  ...
  def test_forceful_question
    ...
    assert_equal "Calm down, I know what I'm doing!", Bob.hey(remark), 'Bob hears "WHAT THE HELL WERE YOU THINKING?", and..'
  end
  ...
  def test_shouting_with_no_exclamation_mark
    ...
    assert_equal 'Whoa, chill out!', Bob.hey(remark), 'Bob hears "I HATE THE DMV", and..'
  end
